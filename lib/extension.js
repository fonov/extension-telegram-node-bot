/**
 * Created by Fonov Sergei on 03.12.16.
 */
            ...
            if (i == keys.length) {
                try {
                    ...
                    var sendConfirmMessage = () => {
                        this._$.sendMessage(formData.config.message.confirm(result), {
                    ...
                    this._$.waitForRequest.then(($) => {
                        if($.message.text == formData.config.button.confirm){
                            this._$.sendMessage(formData.config.message.finish(result), {
                                disable_web_page_preview: true,
                                parse_mode: 'HTML',
                                reply_markup: JSON.stringify({
